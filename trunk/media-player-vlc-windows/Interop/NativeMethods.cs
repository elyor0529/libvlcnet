...
namespace DZ.MediaPlayer.Vlc.Windows.Interop {
	internal static class NativeMethods {
		...
		public static extern int SetWindowPos(IntPtr hWnd, IntPtr pos, int X, int Y, int cx, int cy, SWP uFlags);
		...
		[SecurityCritical]
		public static IntPtr CreateWindowEx(WindowsStyleEx dwExStyle, string lpszClassName, string lpszWindowName,
		...
		[SecurityCritical]
		public static int MsgWaitForMultipleObjectsEx(int nCount, IntPtr[] pHandles, int dwMilliseconds,
		...
		[SecurityCritical]
		public static ushort RegisterClassEx(WNDCLASSEX_D wc_d) {
		...
		public static extern IntPtr IntCreateWindowEx(WindowsStyleEx dwExStyle, string lpszClassName, string lpszWindowName,
		                                                WindowsStyle style, int x, int y, int width, int height,
		                                                IntPtr hWndParent, IntPtr hMenu, IntPtr hInst,
		                                                [MarshalAs(UnmanagedType.AsAny)] object pvParam);
		...
		[DllImport("gdiplus.dll", ExactSpelling = true)]
		public static extern int GdiplusStartup(ref ulong handle, ref GdiplusStartupInput startup, IntPtr zero);

		[DllImport("gdiplus.dll", ExactSpelling = true)]
		public static extern int GdiplusShutdown(ref ulong handle);
		...
		public static extern IntPtr CreateDIBitmap(IntPtr hdc, IntPtr header, uint fdwInit, IntPtr bits, IntPtr headerInfo,
		                                             uint fuUsage);

		public static IntPtr CreateDIBPalette(IntPtr bitmapInfo) {
		...
		public static int DIBNumColors(IntPtr ptr) {
			int bitCount = 0;
		...
		[DllImport("gdi32.dll")]
		public static extern IntPtr CreatePalette(IntPtr lplgpl);
	...
	public struct WindowMessage {
		...
		public WindowMessage(IntPtr handle, int code, IntPtr wParam, IntPtr lParam, int messageTime, int posX, int posY) {
			windowHandle = handle;
			messageCode = code;
			this.wParam = wParam;
			this.lParam = lParam;
		...
		public WindowMessage(IntPtr handle, int code, IntPtr wParam, IntPtr lParam, int messageTime) {
			windowHandle = handle;
			messageCode = code;
			this.wParam = wParam;
			this.lParam = lParam;
		...
		public WindowMessage(IntPtr handle, int code, IntPtr wParam, IntPtr lParam) {
			windowHandle = handle;
			messageCode = code;
			this.wParam = wParam;
			this.lParam = lParam;
