...
namespace SimplePlayer {
	partial class OpenNetworkStreamDialog {
		/// <summary>
		...
		private void InitializeComponent() {
			...
			this.label1.Text = "Enter a network URL:";
			// 
			// urlTextBox
			// 
			...
			this.okButton.Location = new System.Drawing.Point(196, 63);
			...
			this.Name = "OpenNetworkStreamDialog";
